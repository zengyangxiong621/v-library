...
const ScrollTable = (props) => {
  ...
  useEffect(() => {
    if (themeConfig) {
      ...
      _tableHeaderConfig.find(item => item.name === 'textStyle').value.find(item => item.name === 'color').value = themeConfig.textColor
      ...
      _tableRowConfig.find(item => item.name === 'selectedBgColor').value = themeConfig.pureColors[3]
