...
const PaginationComp=(props)=>{
  ...
  const componentData = (props.comData && props.comData.length) ? props.comData : staticData.data; // 过滤后的数据
  ...
  let pageKey="page",pageSizeKey="pageSize",total="total";
  ...
  const handleMouseLeave = (e) => {
    props.onMouseEnter && props.onMouseLeave(e, {
      [pageKey]:current,
      [pageSizeKey]:curPageSize,
      [total]: componentData[0][_fields]
    });
