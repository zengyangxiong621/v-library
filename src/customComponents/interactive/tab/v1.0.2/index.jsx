...
const Tab = (props) => {
  let { history, dashboardId, themeConfig } = props
  ...
  useEffect(() => {
    if(themeConfig) {
      ...
      _unselectedConfig.find(item => item.name === 'textStyle').value.find(item => item.name === 'color').value = themeConfig.assistColor
