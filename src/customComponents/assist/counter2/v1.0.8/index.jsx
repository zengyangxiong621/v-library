...
class Counter extends Component {
  ...
  render() {
    ...
    // 正负值配置翻牌器
    const plusMinusConfig = this.getStyleData(copyConfig, "plusMinusConfig")
      ? this.formatConfig([this.getStyleData(copyConfig, "plusMinusConfig")], [])
      : {};
    let finalValue = 0;
    let carrySign = false;
    // 判断数据是否携带正负标签
    if (Number(originData[fields[1]])) {
      finalValue = Number(originData[fields[1]]);
      carrySign =
        typeof originData[fields[1]] === "string" && originData[fields[1]].indexOf("+") > -1
          ? true
          : false;
    }
        ...
        <div className="counter-number">
          {prefixConfig.support && (
            <span
              style={{
                ...
                color: plusMinusConfig?.show
                  ? finalValue > 0
                    ? plusMinusConfig.positiveColor
                    : plusMinusConfig.negativeColor
                  : prefixConfig.color,
              }}
            >
          ...
          >
            ...
            {animate === "open" ? (
              ...
              <span>
                {carrySign && "+"}
                {this.formatCount(originData[fields[1]], splitCount, decimalCount)}
              </span>
            )}
          </div>
              ...
              style={{
                ...
                color: plusMinusConfig?.show
                  ? finalValue > 0
                    ? plusMinusConfig.positiveColor
                    : plusMinusConfig.negativeColor
                  : suffixConfig?.themePureColor || "#0F92FF",
              }}
            >
