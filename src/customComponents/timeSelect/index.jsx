    ...
    > {
      selectType === 'range' ?
        <RangePicker
          ...
          picker={ pickerType }
          format={ dateFormat }
          style={ { width: '100%', height: '100%', background: selectBgColor, border: '1px solid red' } }
        ...
        /> : <DatePicker
          ...
          picker={ pickerType }
          format={ dateFormat }
          style={ { width: '100%', height: '100%', background: selectBgColor, border: `1 px solid ${selectBorderColor}` } }
          showTime={ dateFormat.indexOf('HH:mm:ss') !== -1 }
          getPopupContainer={ triggerNode => triggerNode.parentNode }
          onOpenChange={ onOpenChange }
          onPanelChange={ onPanelChange }
