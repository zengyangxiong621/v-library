    ...
    const options = {
      ...
      series: [
        ...
        // 黄色标牌
        {
          ...
          symbol: img.yellow,
          symbolSize: [600*SCALE, 240*SCALE],
          symbolOffset: [360*SCALE, -150*SCALE],
          z: 999,
        ...
        // 蓝色标牌
        {
          ...
          label: {
            normal: {
              ...
              rich: {
                fline: {
                  padding: [-30*SCALE, -75*SCALE, 84*SCALE, -45*SCALE], // 调整标牌文字位置
                  color: "#00d3ff",
                  fontSize: 42*SCALE,
                  fontWeight: 400,
                },
          ...
          // symbol: "roundRect",
          // symbolSize: [44, 70], 
          symbolSize: [132*SCALE, 210*SCALE],
          symbolOffset: [0, -90*SCALE],
          z: 999,
          data: this.convertIPData(ipData, ipCoordData),
        },
        ...
        // 柱状体的顶部
        {
          ...
          symbol: img.orange,
          symbolSize: [60*SCALE, 96*SCALE],
          symbolOffset: [0, -30*SCALE],
          z: 999,
          // silent: true,
    ...
    return (
      <div className='ch-map'>
        <div className='map-content'>
          ...
          />
          <div style={{ transform: "scale(" + SCALE + ")", height: (85/SCALE)+"%" }} className="bg-box"><img className='bg1' src={chMap1} alt='背景1'/></div>
          <div style={{ transform: "scale(" + SCALE + ")", height: (85/SCALE)+"%" }} className="bg-box"><img className='bg2' src={chMap2} alt='背景2'/></div>
        </div>
      </div>
    );
  }
