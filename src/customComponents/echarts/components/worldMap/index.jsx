...
let coordData = {
  ...
  勘探院数据中心: [116.363326,40.001572],
  辽河区域中心: [123.478764,41.792053],
  吉林区域中心: [126.621151,43.909917],
  北京区域中心: [116.244838,40.170961],
  西安区域中心: [109.13736,34.345595],
  华东区域: [109.13736,34.345595],
...
let convertData = function (data) {
  ...
  for (let i = 0; i < data.length; i++) {
    ...
    let toCoord = [116.244838,40.170961] //中心点地理坐标
