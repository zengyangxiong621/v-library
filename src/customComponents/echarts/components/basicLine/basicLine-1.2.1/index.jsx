...
const BasicLine = (props) => {
  ...
  const {
    ...
    blankOfSides,
    xGridLine: { showXGridLine, xGridLineType, xGridLineColor, xGridLineWeight },
  ...
  const {
    ...
    yGridLine: { showYGridLine, yGridLineType, yGridLineColor, yGridLineWeight },
