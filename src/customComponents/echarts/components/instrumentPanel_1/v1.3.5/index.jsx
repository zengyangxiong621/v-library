...
const InstrumentPanel = (props) => {
  ...
  const {
    numberRange,
    numberStyles: { textStylerNumbe, offset: numberOffset },
  } = allSettings ? allSettings["指标"] : {};
  const {
    titleStyles: { showTitleStyles, offset, textStyleTitle },
  } = allSettings ? allSettings["标题"] : {};
...
export { InstrumentPanel, ComponentDefaultConfig };
