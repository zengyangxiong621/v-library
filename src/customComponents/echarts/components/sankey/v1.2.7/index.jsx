...
const Sankey = (props) => {
  ...
  const nodes = firstData ? deepClone(firstData[finalFieldsArr[0]]) : [];
  const links = firstData ? deepClone(firstData[finalFieldsArr[1]]) : [];
  ...
  const onChartClick = (param, echarts) => {
    props.onClick && props.onClick(param.event.event, param.data);
  };
  let onEvents = {
    click: onChartClick
  };
