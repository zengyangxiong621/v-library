...
const UploadImg = (props) => {
  ...
  return (
    <Form className="custom-form custom-upload-form" form={form} {...formItemLayout} colon={false}>
      ...
      <Form.Item label={_data.displayName}>
        <Form.Item name="bgImage" valuePropName="fileList" getValueFromEvent={normFile} noStyle>
          <Upload
            name="file"
