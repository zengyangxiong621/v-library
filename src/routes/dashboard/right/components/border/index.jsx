...
import "./index.less";
import { isHex, hexToRgb, getRgbaNum } from "../../../../../utils/color";
    ...
    <Form className="custom-form chart-radius" form={form} {...formItemLayout} colon={false}>
      <Form.Item name="border" label={_data.displayName}>
        ...
        <Form.Item name="color" noStyle>
          <div className="color-swatch" onClick={(e) => selectBgc(e)} style={{ marginRight: 0 }}>
            <div
              className="color-dis"
              style={{
        ...
        <Row style={{ width: "100%" }}>
          <Col span={10} className="detail-txt">
            线型
          </Col>
          <Col span={10} className="detail-txt" style={{ textIndent: "4px" }}>
            粗细
          </Col>
          <Col span={4} className="detail-txt" style={{ textIndent: "6px" }}>
            颜色
          </Col>
        </Row>
      </Form.Item>
