...
import { Form, Select, InputNumber, Checkbox, Collapse } from "antd";
...
const LoadAnimation = (props) => {
  ...
  const [timingFunction, setTimingFunction] = useState(
    _data?.mountAnimation?.timingFunction || "linear"
  );
