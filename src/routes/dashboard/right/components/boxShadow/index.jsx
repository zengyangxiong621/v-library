...
const BoxShadow = (props) => {
  ...
  return (
    <Form className="custom-form" form={form} {...formItemLayout} colon={false}>
      <Form.Item name="outside" label={_data.displayName}>
        <Input.Group compact className="fontBi">
          ...
          >
            <div
              className="color-dis"
              style={{
                background: `rgba(${shadow.rgb.r}, ${shadow.rgb.g}, ${shadow.rgb.b}, ${shadow.rgb.a})`,
              }}
            />
          </div>
          {displayColorPicker ? (
          ...
          <Form.Item name="hShadow" noStyle>
            <InputNumber
              controls={false}
              defaultValue={shadow.hShadow}
              className="po-size-input shadow-input"
              onBlur={(e) => shadowChange("hShadow", e)}
            />
          </Form.Item>
          <Form.Item name="vShadow" noStyle>
            <InputNumber
              controls={false}
              defaultValue={shadow.vShadow}
              className="po-size-input shadow-input"
              onBlur={(e) => shadowChange("vShadow", e)}
            />
          </Form.Item>
          ...
          <Form.Item name="extend" noStyle>
            <InputNumber
              disabled
              controls={false}
              defaultValue={shadow.extend}
              className="po-size-input shadow-input"
              onBlur={(e) => shadowChange("extend", e)}
            />
          </Form.Item>
        </Input.Group>
        <Row>
          <Col span={8} className="detail-txt" style={{ textIndent: "44px" }}>
            X
          </Col>
          <Col span={4} className="detail-txt" style={{ textIndent: "16px" }}>
            Y
          </Col>
          <Col span={6} className="detail-txt" style={{ textIndent: "24px" }}>
            模糊
          </Col>
          <Col span={6} className="detail-txt" style={{ textIndent: "16px" }}>
            扩展
          </Col>
        </Row>
      </Form.Item>
