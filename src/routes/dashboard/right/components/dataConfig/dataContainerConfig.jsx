...
const DataContainerConfig = ({ bar, dispatch, ...props }) => {
  ...
  return (
    <div className="data-container-config">
      <div
        className="data-container-select g-flex g-justify-between g-mt-4 g-mb-9"
        style={{ display: "flex" }}
      >
        <span style={{ minWidth: "73px", lineHeight: "32px" }} className="g-text-left">
          数据容器
        </span>
        <Select
        ...
        <Button className="g-ml-2" onClick={handleAddDataContainer}>
          +新建
        </Button>
      </div>
          ...
          if (dataContainer) {
            return (
              <div
                ...
                className={`data-container-tabs-item ${item.id === tabValue ? "data-container-tabs-item-active " : ""
                  }g-cursor-pointer g-overflow-hidden g-overflow-ellipsis g-whitespace-nowrap`}
      ...
      <div className="data-container-show-card" style={{ width: "100%", height: "198px" }}>
