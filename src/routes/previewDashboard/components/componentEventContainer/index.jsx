...
import FlowChart from "@/customComponents/echarts/components/flowChart/v1.0.1";
...
const ComponentEventContainer = ({
  ...
  return (
    ...
    >
      ...
      ) : props.componentConfig.moduleName === "flowChart" ? (
        <FlowChart {...props} onChange={handleValueChange}></FlowChart>
