...
const Carousel = ({
  ...
  const addCarouselItems = () => {
    ...
    document
      .getElementById(`carousel_3d_id_${settings.middle}`)
      .classList.add("carousel____middle");
    document
      .getElementById(`carousel_3d_id_${settings.middle}`)
      .classList.add("carousel_____zIndex4");
    settings.title = "";
  };
  ...
  const removeCarouselItems = () => {
    ...
    document
      .getElementById(`carousel_3d_id_${settings.right}`)
      .classList.remove("carousel____right");

    document
      .getElementById(`carousel_3d_id_${settings.left}`)
  ...
  const handleCarouselLeftClick = () => {
    ...
    document
      .getElementById(`carousel_3d_id_${settings.right}`)
      .classList.add("carousel_____zIndex2");
    document
      .getElementById(`carousel_3d_id_${settings.left}`)
      .classList.add("carousel_____zIndex3");
  };
  ...
  const handleMouseEnter = () => {
    document
      .getElementById("carousel_____image-overlay-" + settings.middle)
        ...
        <div className={`carousel_____container ${className}`} id={id}>
          {showArrowsStatus ? (
            <div className="carousel_____indicators-wrapper">
              <div
                className="carousel_____arrow-indicators carousel_____arrow-indicators-prev"
                id="carousel_____left-arrow"
                onClick={() => handleCarouselLeftClick()}
              />
              <div
                className="carousel_____arrow-indicators carousel_____arrow-indicators-next"
