...
const UploadFile = (props: any) => {
  ...
  const generateUploadProps = (
    ...
    let fileSuffix = isTemp ? ".zip" : materialType ? 'video/mp4,video/avi,video/x-ms-wmv,audio/x-m4a,audio/mpeg,audio/ogg,audio/mp3,audio/wav,audio/m4a,audio/flac' : "image/png,image/jpeg,image/jpg"
    // 上传框配置
