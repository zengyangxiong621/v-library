import { IPanel, IComponent } from "@/routes/dashboard/center/components/CustomDraggable/type";
import {
  ILayerPanel,
  ILayerComponent,
  ILayerGroup,
...
type IFullAmountLayers = Array<
  | (ILayerPanel & { modules: IFullAmountLayers })
  | ILayerComponent
  | ILayerGroup
  | { name: string; id: string; modules: IFullAmountLayers }
>;
  ...
  moduleDefaultConfig: [
    {
      ...
      staticData: {
        data: [
          { column1: "北京", column2: 87.2, column3: "超预期" },
          {
            column1: "上海",
            column2: 80.5,
            column3: "达标",
        ...
        fields: [
          { name: "column1", value: "column1", desc: "文本" },
          {
            name: "column2",
            value: "column2",
            desc: "文本",
        ...
        },
        {
          ...
          value: [
            ...
            },
            {
              ...
              type: "select",
              options: [
                { name: "逐条滚动", value: "single" },
                { name: "整页滚动", value: "page" },
              ],
              value: "single",
            },
            {
        ...
        },
        {
          ...
          value: [
            ...
            },
            {
              ...
              value: [
                { displayName: "", name: "fontFamily", value: "Microsoft Yahei" },
                {
                  displayName: "",
                  name: "fontSize",
                  value: 14,
                ...
                template: [
                  {
                    ...
                    value: [
                      ...
                      },
                      {
                        ...
                        type: "image",
                        value:
                          "http://10.201.81.47:9000/soc-visualization-public/static/png/1%E5%A4%87%E4%BB%BD-HwFPT.png",
                      },
                    ],
                  },
                ],
